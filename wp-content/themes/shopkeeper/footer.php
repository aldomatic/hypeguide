...
if (jQuery(".easyzoom").length ) {
  ...
  setTimeout(function() {
		jQuery(".easyzoom").prepend('<a href='+jQuery("a.social_media_pinterest").attr("href")+' target="_blank" style="display: inline-block;position: absolute;bottom: 10px;left: 10px;padding:0 10px;color: #CC1A1C;font-size: 50px;z-index:100;" class="social_pinit_btn"><i class="fa fa-pinterest"></i></a>');
		jQuery("a.social_pinit_btn").on("click", function(event){
			event.preventDefault();
