...
try {
	...
	$client = new WC_API_Client( 'http://hypeguide.staging.wpengine.com/', 'ck_849914eb22b484448b3d2aea3c6789cf', 'cs_5157c569230074f606d21c2fe8e915d2', $options );
	...
	// products
	print_r(json_encode($client->products->get(null, array( 'filter[limit]' => 50, 'filter[category]' => 'home-and-living' ))));
